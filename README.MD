...
##### Archivo de creación de contnedores
...
Si el tópico no aparece en la lista anterior, créalo manualmente ejecutando este comando dentro del mismo contenedor kafka1:
